...
$.ajax({
        ...
        headers: {'Authorization': `Bearer ${document.cookie}`},
       success:function(data){
       	weightSal = data.weightSal
       	weightFin = data.weightFin
       	weightPro = data.weightSal
       	weightRes = data.weightRes
       	document.getElementById("weightRes").innerHTML = data.weightRes
       	document.getElementById("weightFin").innerHTML = data.weightFin
       	document.getElementById("weightSal").innerHTML = data.weightSal
       	document.getElementById("weightPro").innerHTML = data.weightSal 
       }
   })